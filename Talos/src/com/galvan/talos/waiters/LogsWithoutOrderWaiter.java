 ...
 */
public class LogsWithoutOrderWaiter extends TalosLogWaiter {
    ...
    //Constructor
    public LogsWithoutOrderWaiter(AppiumDriver driver, ArrayList<TalosLogDetector> detectors){
        super(driver);
        if(detectors == null)
    ...
    protected boolean shouldStopWaiting() {
        synchronized (mRequetedLogsDetectors) {
            ...
            return mRequetedLogsDetectors.size() == 0;
        }
    }
